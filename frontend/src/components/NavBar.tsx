...
const NavBar = ({ handleShowModal }: { handleShowModal: () => void }) => {
  ...
  return (
    <header
      className={`scroll fixed z-50 flex h-auto w-full items-center justify-between bg-black p-5 tablet:p-0 tablet:ml-0    mobile:text-xs`}
    >
    
   

      {/* Logo and Title */}
      <div className="flex items-center  tablet:pl-6">
        <a
          href="/"
        ...
        >
         ...
         {/* Mobile Menu Button */}
      <div className="mobile-shadow ml-28 z-50 py-3 hidden h-full rounded-xl tablet:flex">
      ...
      {/* Mobile Menu */}
      <div
        className={`absolute z-[99999] left-0 top-0 bg-black ${isMobileMenuOpen ? 'block' : 'hidden'}`}
      >
      ...
      <div className="flex items-center gap-2 tablet:hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href="tel:6787795280" className="text-white mr-5"> 678-779-5280</a>
        </div>
        <Button
          className="rounded-md bg-red-600 px-4 py-2 text-sm text-white hover:bg-red-500 mobile:text-xs"
          onClick={handleShowModal}
       ...
       <div className="absolute -bottom-7 py-1 bg-red-500 rounded-b-md left-0 items-center gap-2 hidden tablet:flex">

        <div className="flex items-center gap-1 px-2">
          <PhoneCall className="text-white size-4" />
          <a href="tel:6787795280" className="text-white text-sm underline "> 678-779-5280</a>
        </div>
