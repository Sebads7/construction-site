    ...
    <div className=" w-full ">
      ...
      <div className="w-full  flex">
        <div className="w-full  bg-gray-900 opacity-70  ">
          <img
            src="/src/assets/pressure washing/pressure-washing5.jpg"
            alt="background"
            className="w-full h-screen object-cover "
          />
        </div>
        <div className="w-full h-full left-0 flex  flex-col items-center  bg-black/40 py-10 absolute   ">
          ...
          <div className="flex flex-col justify-center items-center h-[27rem] w-full bg-gray-900/20 p-10 shadow-xl">
            ...
            <h2 className="w-[70rem] text-white text-center leading-7 [&:not(:first-child)]:mt-6 text-xl">
              At ABJ Pressure Washing Services, we specialize in revitalizing
              surfaces with expert care and attention. Whether you're looking to
              restore the shine of your exterior or remove stubborn stains, our
              skilled team is here to bring out the best in your property. From
              driveways and decks to siding and fences, we offer a comprehensive
              range of pressure washing solutions to keep your home looking its
              best.
            </h2>
          </div>
        </div>
