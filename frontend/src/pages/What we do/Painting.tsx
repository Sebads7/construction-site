    ...
    <div className=" w-full ">
      ...
      <div className="w-full  flex">
        <div className="w-full  bg-gray-900 opacity-70  ">
          <img
            src="/src/assets/painting/painting4.jpeg"
            alt="background"
        ...
        <div className="w-full h-full left-0 flex  flex-col items-center  bg-black/50 py-10 absolute">
          ...
          <div className="flex flex-col justify-center items-center h-[27rem] w-full bg-gray-900/10 p-10">
            <h1 className="mb-4 text-white scroll-m-20 text-4xl font-extrabold tracking-wider lg:text-5xl  ">
              Transforming Interiors and Exteriors with Precision
            </h1>
            <h2 className="w-[70rem] text-white text-center leading-7 [&:not(:first-child)]:mt-6 text-xl">
              At ABJ Painting & Remodeling, we specialize in transforming
              interiors and exteriors with stunning painting services that
              seamlessly blend functionality with aesthetic appeal. Whether you
              envision refreshing your living spaces or enhancing your
              property's curb appeal, our skilled team is dedicated to bringing
