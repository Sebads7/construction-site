      ...
      <div className="relative h-screen lg:h-full">
        ...
        <div className="relative flex h-full flex-row mobile:flex-col">
          <div className="flex w-full flex-row bg-black/50 lg:flex-col mobile:items-center">
            ...
            >
              <h1 className="mb-4 max-w-2xl pt-1 text-6xl font-extrabold tracking-wider text-white lg:pt-[10rem] lg:text-5xl tablet:pt-[7rem] tablet:translate-y-1 mobile:text-4xl">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p> Atlanta, GA, and surrounding areas</p>
              </div>
            </div>
